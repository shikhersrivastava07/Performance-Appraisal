...
?>
			<div>
				<div class="text-center form">
					<div class="details">
						<h2 class="text-center visible-lg-inline bg-info">Employee Login</h2>
						<a href="index.php" class="pull-right btn btn-primary">Back</a>
					</div>
					<form method="POST">
						<div class="form-group">
							<label class="font-weight-bold" >User Name</label>
							<input type="text" name="uname" class="form-control col-lg-8 mx-auto"   placeholder="Enter Username" pattern="^[a-zA-Z\s]+$" title="Username Should only contain letters">
					    </div>
						<div class="form-group">
...
if(isset($_POST['login'])){
	...
	$query="SELECT * FROM `employee` WHERE employee_name='$username' AND e_pass='$password';";
